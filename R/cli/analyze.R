...
if (command == "heritability") {
    if (nrow(studies_df) == 0 && original_study_count > 0) {
        ...
        source("R/analysis/heritability.R")
    ...
    source("R/analysis/polygenicity.R")
    ...
    source("R/analysis/replication.R")
    ...
    source("R/analysis/effect_replication.R")
    ...
    source("R/analysis/distribution.R") # Source the relevant R script
