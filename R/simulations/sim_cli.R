...
source(file.path(script_dir, "..", "analysis", "heritability.R"))
...
main <- function(args) {
  ...
  if (command == "polygenicity") {
    ...
    source(file.path(script_dir, "..", "analysis", "polygenicity.R")) # For calculate_polygenicity_metrics
    ...
    source(file.path(script_dir, "..", "analysis", "distribution.R"))
