...
if (command == "heritability") {
    if (nrow(studies_df) == 0 && original_study_count > 0) {
        ...
        source("src/analysis/heritability.R")
    ...
    source("src/analysis/polygenicity.R")
    ...
    source("src/analysis/replication.R")
    ...
    source("src/analysis/effect_replication.R")
    ...
    source("src/analysis/distribution.R") # Source the relevant R script
